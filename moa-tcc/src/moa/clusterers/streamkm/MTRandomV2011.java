 ...
 * 
 */
public class MTRandomV2011 extends Random {
	 ...
	 * behaviour.
	 */
	public MTRandomV2011(boolean compatible) {
		super(0L);
		compat = compatible;
	 ...
	 */
	public MTRandomV2011(long seed) {
		super(seed);
	}
