...
public class StreamKMElaine extends AbstractClusterer {
    ...
    public void trainOnInstanceImpl(Instance inst) {
		...
		if (this.numberInstances % widthOption.getValue() == 0) {
			...
			for(int i = 1; i < 5; i++){
				...
				Point[] tmpCentresStreamingCoreset= new Point[numberOfCentres];
    ...
    public double lloydPlusPlus(int k, int n, int d, Point points[], Point centres[]){
		...
		Point x [] =chooseRandomCentres(k, n, d, points);
